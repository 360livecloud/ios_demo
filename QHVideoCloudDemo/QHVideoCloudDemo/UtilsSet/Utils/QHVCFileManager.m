...
@implementation QHVCFileManager
...
{
    return [[QHVCFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[QHVCFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[QHVCFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[QHVCFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[QHVCFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[QHVCFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
